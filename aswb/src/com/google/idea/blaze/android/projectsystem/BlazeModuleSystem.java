...
public class BlazeModuleSystem extends BlazeModuleSystemBase {
  ...
  static ExternalAndroidLibrary toExternalLibrary(
    ...
    String resourcePackage = getResourcePackage(library, manifest, aarFile);
  ...
  private static String getResourcePackage(@NotNull AarLibrary aarLibrary,
                                           PathString manifest,
                                           File aarFile) {
    String resourcePackage = aarLibrary.resourcePackage;
